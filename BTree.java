...
*/        
        System.out.println("cs.princeton.edu:  " + st.get("c"));
        System.out.println("hardvardsucks.com: " + st.get("www.harvardsucks.com"));
        System.out.println("simpsons.com:      " + st.get("s"));
        System.out.println("apple.com:         " + st.get("a"));
        System.out.println("ebay.com:          " + st.get("e"));
        System.out.println("dell.com:          " + st.get("d"));
        System.out.println();
